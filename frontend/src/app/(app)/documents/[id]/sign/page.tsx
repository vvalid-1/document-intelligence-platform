    ...
    <div className="p-8">
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div className="flex-1 space-y-5">
          ...
          <Card>
            <CardHeader title="Position" subtitle="Click the page preview or enter coordinates" />
        ...
        <div className="shrink-0">
          <p className="mb-2 text-sm font-medium text-gray-700">Page preview — click to place</p>
          <div
            ref={previewRef}
          ...
          >
            {/* Page lines for visual reference */}
